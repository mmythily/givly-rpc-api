...
It is generated from these files:
	pkg/rpc/transaction/transaction.proto
*/
package transaction
...
type TransactionService interface {
	...
	CreateItems(context.Context, *ItemList) (*ItemList, error)
...
func (c *transactionServiceProtobufClient) CreateItems(ctx context.Context, in *ItemList) (*ItemList, error) {
	ctx = ctxsetters.WithPackageName(ctx, "transaction")
	ctx = ctxsetters.WithServiceName(ctx, "TransactionService")
	ctx = ctxsetters.WithMethodName(ctx, "CreateItems")
	out := new(ItemList)
...
func (c *transactionServiceJSONClient) CreateItems(ctx context.Context, in *ItemList) (*ItemList, error) {
	ctx = ctxsetters.WithPackageName(ctx, "transaction")
	ctx = ctxsetters.WithServiceName(ctx, "TransactionService")
	ctx = ctxsetters.WithMethodName(ctx, "CreateItems")
	out := new(ItemList)
...
func (s *transactionServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "/twirp/transaction.TransactionService/GetItemList":
		...
		return
	case "/twirp/transaction.TransactionService/CreateItems":
		s.serveCreateItems(ctx, resp, req)
		return
...
func (s *transactionServiceServer) serveCreateItems(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveCreateItemsJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveCreateItemsProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *transactionServiceServer) serveCreateItemsJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "CreateItems")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.TransactionService.CreateItems(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *ItemList and nil error while calling CreateItems. nil responses are not supported"))
		return
	}
...
func (s *transactionServiceServer) serveCreateItemsProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "CreateItems")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
